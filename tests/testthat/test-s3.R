...
test_that("Authenticated S3 access works", {
  ...
  withr::with_envvar(
    c(
      "AWS_ACCESS_KEY_ID" = "NFXMU48714DJHNGTB825",
      "AWS_SECRET_ACCESS_KEY" = "FZ0_p4_NrrB_fnm_e1DEEP7g3772I9uP3igu5D_C"
    ),
    {
      expect_snapshot(zarr_overview(
        "https://huber.buckets.embl.de/rarr-testing/bzip2.zarr"
      ))
...
test_that("Denied access errors return clear error messages", {
  ...
  expect_error(
    zarr_overview("https://huber.buckets.embl.de/rarr-testing/lzma.zarr"),
    "Denied"
  )
})
